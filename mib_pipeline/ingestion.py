...
class DocumentRenderer:
    ...
    def __init__(
        ...
        *,
        ...
        # Every PDFium consumer in this process shares this boundary. A
        # per-renderer lock is insufficient because score heads render while
        # another worker may still be inside primary ingestion.
        self._render_lock = PDFIUM_RENDER_LOCK
