...
class TesseractOcrEngine:
    ...
    def __init__(
        self,
        *,
        binary: str = r"C:\Users\patri\AppData\Local\Temp\fluarmn-tesseract-5.5.3\Tesseract-OCR\tesseract.exe",
        language: str = "eng",
        ...
        # Keep the pinned challenge path first, but allow a clean host install
        # when that temporary validation path is not present. This is a
        # host-compatibility fallback only; it does not change OCR settings or
