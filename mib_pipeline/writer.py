        ...
        try:
            with os.fdopen(descriptor, "w", encoding="utf-8", newline="\n") as handle:
                ...
                for row in ordered_rows:
                    ...
                    handle.write("\n")
                handle.flush()
                # The official runner creates a host-owned 0755 bind directory.
                # The container writes as root for cross-host compatibility, so
                # make each atomically published output readable by the caller.
