...
TRAIN_LABELS = ROOT / "data" / "train_labels.csv"
...
class EvaluationTests(unittest.TestCase):
    @unittest.skipUnless(
        ...
        "public training labels are not checked into the solution repository",
    )
    def test_perfect_training_predictions_score_150(self):
        truth = evaluate.read_truth(TRAIN_LABELS)
        predictions = []
    ...
    def test_evaluation_result_matches_schema(self):
        ...
        with TRAIN_LABELS.open(newline="") as handle:
