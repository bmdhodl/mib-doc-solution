...
Many pinned Python wheels retain license and NOTICE files inside the installed
package tree. Supplemental notices cover wheels that do not. In particular,
...
- the supplemental FlatBuffers notice in `FlatBuffers/NOTICE.md` and the
  complete Apache License 2.0 text referenced there;
...
and packaging. A metadata identifier is not presented as a bundled notice;
the file inventory above controls that claim.
